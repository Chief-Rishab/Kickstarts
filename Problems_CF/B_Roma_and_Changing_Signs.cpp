...
// The elements will be stroed in a Min Heap decleared here,
// Insertions and Deletions in a Min/Max Heap(PQ) takes O(log n) time
// For k opertaions the time complexity is k log(n) 

int32_t main()
{
    IOS;
    int n,k,sum=0,x; cin>>n>>k;
