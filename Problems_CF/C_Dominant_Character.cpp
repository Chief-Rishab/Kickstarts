...
ll n,t;main()
{
    ...
    while(t--)
    {
        ...
        cin>>s;
        ll f=0;
        for(ll i=0;i<n-1 and !f;i++) if(s[i]=='a' && s[i+1]=='a') {cout<<2<<"\n"; f=1; break;}
        for(ll i=0;i<n-2 and !f;i++) {if((s[i]=='a' && s[i+1]=='b' && s[i+2]=='a')||(s[i]=='a' && s[i+1]=='c' && s[i+2]=='a')) {cout<<3<<"\n"; f=1; break;}}
        for(ll i=0;i<n-3 and !f;i++) {if((s[i]=='a' && s[i+1]=='c' && s[i+2]=='b' && s[i+3]=='a')||(s[i]=='a' && s[i+1]=='b' && s[i+2]=='c' && s[i+3]=='a')) {cout<<4<<"\n"; f=1; break;}}
        if(!f) cout<<-1<<"\n"; 
    }
}